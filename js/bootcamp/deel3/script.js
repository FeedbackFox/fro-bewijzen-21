...
function instruction9() {
    ...
    var result = document.getElementById("instructionResult");
    ...
    paragraph.appendChild(btnLeft);
    paragraph.appendChild(btnRight);
...
function instruction10() {
    var mediacollege = "Mediacollege Amsterdam";
    var result = "de string waar de bewerkingen op gedaan worden is: " + mediacollege + "<br/>";
    
    result += "De lentge van de string is: " + mediacollege.length + "<br/>";

    mediacollege = " " + mediacollege.substr(1);

    result += "De eerste letter is vervangen door een spatie: " + mediacollege + "<br/>";
    result += "De lengte van de string is nog steeds: " + mediacollege.length + "<br/>";

    mediacollege = mediacollege.trim();

    result += "Alle spaties aan het begin en eind zijn nu verwijderd: " + mediacollege + "<br/>";
    result += "De lengte van de string is nu: " + mediacollege.length + "<br/>";

    var words = mediacollege.split(" ");

    result += "Het aantall woorden is: " + words.length + "<br/>";
